...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_ALLIANCE_VERSION = "alliance_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_ALLIANCE_VERSION, "ro.alliance.version");
        findPreference(KEY_ALLIANCE_VERSION).setEnabled(true);
